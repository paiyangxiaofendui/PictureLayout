...
// 最低轮廓线
int CSolution::New_LayoutOptimization_LowestOutline(int CutStyle, int Org)
{
	bool bUseRmd = false;
	Panel* pPanel;
	...
	{
		// 排版优化
		ALGORITHM_API::New_LayoutOnePanel_LowestOutline(pPanel, m_BaseInfo, m_ComponentList, CutStyle, Org);
